...
Time, NUMBER = 0, 720*7
Qk = np.diag([ 1e-14, 1e-14, 1e-14, 1e-14, 1e-14, 1e-14, 1e-14, 1e-14, 1e-14, 1e-14, 1e-14, 1e-14 ]) * 1e-2  # 12*12
...
#############################################################################################################
	...
	def plot_filter(self, X, number):
		...
		plt.legend(); plt.tight_layout(); plt.savefig("Figure/FourChapter/A星位置收敛曲线.png", dpi=400, bbox_inches='tight')
		...
		plt.legend(); plt.tight_layout(); plt.savefig("Figure/FourChapter/A星速度收敛曲线.png", dpi=400, bbox_inches='tight')
		...
		plt.plot(time_range, up_error, "k:")
		plt.plot(time_range, low_error, "k:", label=" $\mathrm{\pm 50 m}$")
		plt.legend(); plt.tight_layout(); plt.savefig("Figure/FourChapter/B星位置收敛曲线.png", dpi=400, bbox_inches='tight')
		...
		plt.plot(time_range, v_upError, "k:")
		plt.plot(time_range, v_lowError, "k:", label=" $\mathrm{\pm 0.05 m/s}$")
		plt.legend(); plt.tight_layout(); plt.savefig("Figure/FourChapter/B星速度收敛曲线.png", dpi=400, bbox_inches='tight')
		
		abs_error = 80 + 1e3 * np.power(e, -time_range)
		plt.figure(5)
		plt.xlabel("时间 / $\mathrm{h}$"); plt.ylabel("位置误差 / ($\mathrm{m}$)")
		plt.plot(time_range, delta_norm_r1 * 1000, "r-", label="A星位置误差")
		plt.plot(time_range, abs_error, "k:", label="+80 m")
		plt.legend(); plt.tight_layout(); plt.savefig("Figure/FourChapter/A星绝对误差曲线.png", dpi=400, bbox_inches='tight')
		
		plt.figure(6)
		plt.xlabel("时间 / $\mathrm{h}$"); plt.ylabel("位置误差 / ($\mathrm{m}$)")
		plt.plot(time_range, delta_norm_r2 * 1000, "b--", label="B星位置误差")
		plt.plot(time_range, abs_error, "k:", label="+80 m")
		plt.legend(); plt.tight_layout(); plt.savefig("Figure/FourChapter/B星绝对误差曲线.png", dpi=400, bbox_inches='tight')
...
if __name__ == "__main__":
	...
	np.save("npy/7days_i=28, P0=3e-2, Qk=1e-14.npy", X)
