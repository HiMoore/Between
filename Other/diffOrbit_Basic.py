...
#############################################################################################################
	...
	def plot_filter_higher(self, X, number):
		...
		plt.legend(); plt.tight_layout(); plt.savefig("Figure/FourChapter/diffOrbit_Basic/A星位置收敛曲线.png", dpi=300, bbox_inches='tight')
		...
		plt.legend(); plt.tight_layout(); plt.savefig("Figure/FourChapter/diffOrbit_Basic/A星速度收敛曲线.png", dpi=300, bbox_inches='tight')
		...
		plt.plot(time_range, up_error, "k:")
		plt.plot(time_range, low_error, "k:", label=" $\mathrm{\pm 30 m}$")
		plt.legend(); plt.tight_layout(); plt.savefig("Figure/FourChapter/diffOrbit_Basic/B星位置收敛曲线.png", dpi=300, bbox_inches='tight')
		...
		plt.plot(time_range, v_upError, "k:")
		plt.plot(time_range, v_lowError, "k:", label=" $\mathrm{\pm 0.02 m/s}$")
		plt.legend(); plt.tight_layout(); plt.savefig("Figure/FourChapter/diffOrbit_Basic/B星速度收敛曲线.png", dpi=300, bbox_inches='tight')
		...
		plt.legend(); plt.tight_layout(); plt.savefig("Figure/FourChapter/diffOrbit_Basic/A星绝对误差曲线.png", dpi=300, bbox_inches='tight')
		
		plt.figure(6)
		plt.xlabel("时间 / $\mathrm{h}$"); plt.ylabel("位置误差 / ($\mathrm{m}$)")
		plt.plot(time_range, delta_norm_r2 * 1000, "b--", label="B星位置误差")
		plt.plot(time_range, abs_error, "k:", label="+50 m")
		plt.legend(); plt.tight_layout(); plt.savefig("Figure/FourChapter/diffOrbit_Basic/B星绝对误差曲线.png", dpi=300, bbox_inches='tight')
...
if __name__ == "__main__":
	...
	# np.save("npy/ia=0, ib=28, P0=3e-2, basic.npy", X)
